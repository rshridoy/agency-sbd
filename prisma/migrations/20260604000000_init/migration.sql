...
-- CreateEnum
CREATE TYPE "LeadSource" AS ENUM ('HOME_DISCOVERY', 'HOME_CALLBACK', 'CONTACT', 'INFLUENCER');
...
-- CreateIndex
CREATE INDEX "CommunityApplication_createdAt_idx" ON "CommunityApplication"("createdAt");
